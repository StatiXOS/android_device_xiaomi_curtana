...
# Power
$(call inherit-product, vendor/hardware/xiaomi/aidl/power-libperfmgr/libperfmgr_product.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(call find-copy-subdir-files,vendor.*.prop,$(LOCAL_PATH)/props/vendor/,$(TARGET_COPY_OUT_VENDOR))
